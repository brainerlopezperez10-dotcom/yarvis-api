...
// Configuración del Bot de Telegram (con parámetros optimizados para evitar conflictos 409)
if (telegramToken) {
  ...
  // Captura de errores de polling para evitar caídas
  bot.on('polling_error', (error) => {
    console.log("Aviso de conexión con Telegram:", error.code || error.message);
  });
