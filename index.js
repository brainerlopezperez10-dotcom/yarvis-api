...
// Identificadores de modelos compatibles con la API
...
// MANEJADOR PRINCIPAL CON REINTENTOS
async function procesarRespuestaIA(mensaje, sessionId, modo, imagen, mimeType) {
  ...
  while (intentos < maxIntentos) {
    try {
      ...
      // Si da error 404 o 429, rota al siguiente modelo de la lista
  ...
  throw new Error("No se pudo conectar con los modelos. Inténtalo de nuevo en unos momentos.");
}
...
if (telegramToken) {
  ...
  bot.on('message', async (msg) => {
    ...
    try {
      ...
      bot.sendMessage(chatId, "⚠️ Ocurrió un error al procesar el mensaje. Inténtalo de nuevo en unos segundos.");
    }
  });
