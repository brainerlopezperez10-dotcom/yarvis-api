...
// Modelos oficiales vigentes y estables
...
// MANEJADOR PRINCIPAL CON REINTENTOS AUTOMÁTICOS
async function procesarRespuestaIA(mensaje, sessionId, modo, imagen, mimeType) {
  ...
  while (intentos < maxIntentos) {
    try {
      ...
      // Si hay límite de cuota (429), rotamos al modelo alternativo y reintentamos
  ...
  throw new Error("Límite de cuota alcanzado temporalmente. Por favor espera unos segundos.");
}
...
if (telegramToken) {
  ...
  bot.on('message', async (msg) => {
    ...
    try {
      ...
      bot.sendMessage(chatId, "⚠️ El sistema está saturado. Por favor, espera unos segundos.");
    }
  });
