...
// Limpia espacios en blanco accidentales en la API Key
...
async function procesarRespuestaIA(mensaje, sessionId, modo, imagen, mimeType) {
  if (!groqApiKey || !groqApiKey.startsWith('gsk_')) {
    throw new Error("GROQ_API_KEY no es válida o falta en las variables de entorno de Render. Debe comenzar por 'gsk_'");
  }
